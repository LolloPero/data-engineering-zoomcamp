...
**SOLUTION:**
```
models/staging/+ includes dim_taxi_trips and dim_fhv_trips, but it does NOT guarantee that fct_taxi_monthly_zone_revenue is selected unless it is downstream of all staging models, which is not.
...
**SOLUTION:**
```
option 4) --> green: {best: 2020/Q1, worst: 2020/Q2}, yellow: {best: 2020/Q1, worst: 2020/Q2}
```
